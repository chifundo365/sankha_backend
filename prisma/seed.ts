...
async function main() {
  ...
  // ─── Seed payout_operators (PayChangu destinations) ───────────
  console.log('Seeding payout_operators...');
  await prisma.payout_operators.deleteMany();
  await prisma.payout_operators.createMany({ data: [
    { uuid: '82310dd1-ec9b-4fe7-a32c-2f262ef08681', name: 'National Bank of Malawi', type: 'BANK', is_active: true },
    { uuid: '87e62436-0553-4fb5-a76d-f27d28420c5b', name: 'Ecobank Malawi Limited', type: 'BANK', is_active: true },
    { uuid: 'b064172a-8a1b-4f7f-aad7-81b036c46c57', name: 'FDH Bank Limited', type: 'BANK', is_active: true },
    { uuid: 'e7447c2c-c147-4907-b194-e087fe8d8585', name: 'Standard Bank Limited', type: 'BANK', is_active: true },
    { uuid: '236760c9-3045-4a01-990e-497b28d115bb', name: 'Centenary Bank', type: 'BANK', is_active: true },
    { uuid: '968ac588-3b1f-4d89-81ff-a3d43a599003', name: 'First Capital Limited', type: 'BANK', is_active: true },
    { uuid: 'c759d7b6-ae5c-4a95-814a-79171271897a', name: 'CDH Investment Bank', type: 'BANK', is_active: true },
    { uuid: '5e9946ae-76ed-43f5-ad59-63e09096006a', name: 'TNM Mpamba', type: 'MOBILE_MONEY', is_active: true },
    { uuid: 'e8d5fca0-e5ac-4714-a518-484be9011326', name: 'Airtel Money', type: 'MOBILE_MONEY', is_active: true },
  ] });
